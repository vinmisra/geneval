#####
#
# Largely derived from diffusers/examples/dreambooth/train_dreambooth.py
# Hackily modified to accept multiple entities and multiple reference classes as a strange ':::'-separated list of strings, and train jointly across the set.
# Much better ways to do this...
# Doesn't currently support weighting of the different entities, but that's easy to add.
#
#####
